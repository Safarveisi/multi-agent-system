...
def check_status(
    ...
    tracking_number: Annotated[str, "The tracking number of the application to check the status for"],
) -> str:
...
def execute_cancellation(tracking_number: Annotated[str, "The tracking number of the application to cancel"]) -> str:
...
status_agent = SwarmAgent(
    ...
    #llm=llm, # Large language model provided by e.g., OpenAI
    instructions=status_agent_instructions,
    functions=[check_status, execute_cancellation, transfer_to_eligibility, transfer_to_finance],
)